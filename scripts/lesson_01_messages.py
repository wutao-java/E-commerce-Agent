"""01 演示 messages 输入和 assistant message 输出。"""
...
def call_chat_model(
    ...
    *,
    ...
    """调用 OpenAI-compatible聊天模型并返回原始响应。"""
    ...
    resolved_base_url = (base_url if base_url is not None else settings.base_url).rstrip("/")
